...
enum class CommandType : std::uint8_t {
   ...
   TARE_THRUST,
   CALIBRATE_THRUST,
   SET_OXIDIZER_LOADCELL_SCALE,
   SET_OXIDIZER_LOADCELL_OFFSET,
   TARE_OXIDIZER_LOADCELL,
   CALIBRATE_OXIDIZER_LOADCELL,
   SET_FUEL_PRESSURE_SCALE,
   SET_FUEL_PRESSURE_OFFSET,
   SET_OXIDIZER_PRESSURE_SCALE,
   SET_OXIDIZER_PRESSURE_OFFSET,
   TARE_PRESSURE,
